/**
 * Wogeno Bern Scraper – Supabase Edge Function
 *
 * Die Wogeno Bern (Wohngenossenschaft) ist eine kleinere Genossenschaft
 * mit rund 200 Wohnungen in der Stadt Bern und Umgebung. Da alle Objekte
 * in Bern liegen, wird kein PLZ-Filter angewendet. Die Scraping-Reihenfolge:
...
const SOURCE_NAME = 'wogeno';
const BASE_URL = 'https://www.wogeno-bern.ch';
const SEARCH_URL = 'https://www.wogeno-bern.ch/freie-wohnungen/';
